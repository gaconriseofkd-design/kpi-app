@echo off
title KPI APP - Xet Duyet KPI - Ortholite Vietnam
echo Dang kiem tra va mo Phan he Xet Duyet KPI...
...
start "" "%EDGE_PATH%" --ignore-certificate-errors --allow-file-access-from-files --allow-file-access --disable-web-security --user-data-dir="%TEMP%\edge_app_profile" --app="file:///%APP_DIR%dist/index.html#/pending"
