...
Write-Host "--- Querying mqaa_settings ---"
...
Write-Host "--- Querying system_settings ---"
$sysUrl = "$SUPABASE_URL/rest/v1/system_settings?id=eq.1"
$sys = Invoke-RestMethod -Uri $sysUrl -Headers $headers -Method Get
$sys | Format-List *
