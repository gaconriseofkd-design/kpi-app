...
echo Dang kiem tra va mo Phan he MQAA Patrol...
...
start "" "%EDGE_PATH%" --ignore-certificate-errors --allow-file-access-from-files --allow-file-access --disable-web-security --user-data-dir="%TEMP%\edge_app_profile" --app="file:///%APP_DIR%dist/index.html#/mqaa-patrol"
